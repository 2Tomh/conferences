...
//   /** Fields that belong to each step, used to validate before moving forward */
...
//     // Allow going back freely, but only forward if previous steps are valid
...
//       // Jump back to the first invalid step
