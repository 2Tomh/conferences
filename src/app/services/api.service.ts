...
export class ApiService {
  ...
  // ⭐ חדש: טרנזקציה בודדת מלאה (כולל טקסט האבסטרקט), לחלון הפרטים
  getTransactionByOrderId(orderId: string): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/payment/transactions/${encodeURIComponent(orderId)}`);
  }
