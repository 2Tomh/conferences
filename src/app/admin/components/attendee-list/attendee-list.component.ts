...
export class AttendeeListComponent implements OnInit {
  ...
  // ⭐ חדש: מחזיר את סימן המטבע הנכון לפי מה שבאמת שולם (₪ או $) במקום סימן קבוע.
  // דורש שהבקנד ישמור שדה Currency/currency על רשומת ה-Attendee (מגיע מ-paymentInputData.currency
  // שכבר נשלח מ-registration-form). אם השדה חסר ברשומות ישנות - נופלים חזרה ל-₪ לתאימות אחורה.
